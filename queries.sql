...
VALUES (1, '2014 Rossignol District Snowboard', 1, 10999, 'img/lot-1.jpg', '2022-11-30 16:16');
INSERT INTO lots (author_id, title, category_id, first_price, image, end_date)
VALUES (2, 'DC Ply Mens 2016/2017 Snowboard', 1, 159999, 'img/lot-2.jpg', '2022-11-29 11:22');
INSERT INTO lots (author_id, title, category_id, first_price, image, end_date)
VALUES (3, 'Крепления Union Contact Pro 2015 года размер L/XL', 2, 8000, 'img/lot-3.jpg', '2022-11-28 19:40');
INSERT INTO lots (author_id, title, category_id, first_price, image, end_date)
VALUES (1, 'Ботинки для сноуборда DC Mutiny Charocal', 3, 10999, 'img/lot-4.jpg', '2022-11-27 21:21');
INSERT INTO lots (author_id, title, category_id, first_price, image, end_date)
VALUES (2, 'Куртка для сноуборда DC Mutiny Charocal', 4, 7500, 'img/lot-5.jpg', '2022-11-26 23:23');
INSERT INTO lots (author_id, title, category_id, first_price, image, end_date)
VALUES (3, 'Маска Oakley Canopy', 6, 5400, 'img/lot-6.jpg', '2022-11-25 23:44');
...
SELECT b.lot_id, l.title, l.first_price, l.image, b.bet_sum AS current_price, c.title
FROM lots AS l
         JOIN bets AS b ON b.lot_id = l.id
         JOIN categories AS c ON c.id = l.category_id
WHERE b.bet_sum = (SELECT MAX(b.bet_sum) FROM bets AS b WHERE b.lot_id = l.id);
